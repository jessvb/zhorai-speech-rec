...
#lab_folder=''
#lab_opts='ali-to-pdf'
out_folder='/workspace/zhorai-workspace/example_speech/data'
#wav_lst='/workspace/zhorai-workspace/example_speech/data/wav.scp'
scp_file_out='/workspace/zhorai-workspace/example_speech/data/feats.scp'
sig_id='speech_example'
...
for del_me in [1]:
    ...
    [fs,signal]=scipy.io.wavfile.read("/workspace/zhorai-workspace/example_speech/data/speech_example.wav")
